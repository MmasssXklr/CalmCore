...
var CONNECTION_STRING = "mongodb+srv://jrquiambao:5Cmpersec..@mydb.teokdgo.mongodb.net/?retryWrites=true&w=majority&appName=Mydb";
...
app.post('/api/books/AddBook', multer().none(), async (req, res) => {
    try {
        ...
        await database.collection("books").insertOne({
            ...
            desc: req.body.desc, // Add description field
